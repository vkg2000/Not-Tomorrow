...
<nav class="navbar navbar-expand-lg navbar-light bg-light">
  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
    ...
    <ul class="navbar-nav mr-auto">
      ...
      &nbsp
       <a href="signup.php"><button class="btn btn-outline-secondary my-2 my-sm-0" type="submit">Sign Up</button></a>
  </div>
</nav>
    ...
    <div class="col-sm">
      <div class="loginform">
        ...
        <div class="form-group " >
          <label for="email"><span class="font1">Username</span></label>
        ...
        <div class="form-group">
          ...
          <button type="submit" class="btn btn-outline-secondary btn-block"  name="signin">Sign In</button>
          </form>
      </div>
    </div>
  </div>
